...
export default function DealsPage() {
    ...
    const handleSave = async () => {
        ...
        await fetch(url, { method, headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ ...form, value: parseFloat(form.value) || 0 }) });
        setShowModal(false);
        fetchDeals();
    };
        ...
        <>
            <div className="data-toolbar">
                <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
                    Kéo thả deal giữa các cột để cập nhật giai đoạn
                </div>
                    ...
                    <div className="modal" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group">
                                    <label>Ngày close dự kiến</label>
                                    <input className="form-input" type="date" value={form.expected_close} onChange={e => setForm({ ...form, expected_close: e.target.value })} />
                                </div>
                            </div>
                            <div className="form-group">
                                <label>Mô tả</label>
